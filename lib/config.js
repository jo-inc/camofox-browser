...
function loadConfig() {
  ...
  return {
    ...
    persistentContext: process.env.CAMOFOX_PERSISTENT_CONTEXT === '1' || process.env.CAMOFOX_PERSISTENT_CONTEXT === 'true',
    userDataDir: process.env.CAMOFOX_USER_DATA_DIR || '',
    ...
    serverEnv: {
      ...
      CAMOFOX_PERSISTENT_CONTEXT: process.env.CAMOFOX_PERSISTENT_CONTEXT,
      CAMOFOX_USER_DATA_DIR: process.env.CAMOFOX_USER_DATA_DIR,
