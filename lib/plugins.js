 ...
 *
 *   SESSION LIFECYCLE
 *     session:creating        { userId, contextOptions, generation }             -- mutate context options
 *     session:created         { userId, context, generation }                    -- after context stored
 *     session:destroying      { userId, reason, context, generation }             -- before context close
 *     session:destroyed       { userId, reason, context, generation }             -- after cleanup
